...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  COMPANY_SUSPENDED: 'La empresa asociada a tu cuenta está suspendida.',
  ROL_NO_PERMITIDO: 'Esta cuenta no corresponde a un usuario — usa la app de proveedores.',
...
export default function LoginScreen() {
  ...
  // never show the login form to an authenticated user.
