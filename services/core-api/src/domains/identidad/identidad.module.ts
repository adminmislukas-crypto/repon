...
// design.md's DI wiring table + tasks.md 4a.5/4b: binds the 3 Kysely-backed
// repositories, `AUTH_PROVIDER` (`SupabaseAuthProvider`, this commit — see
// its own file doc comment for why it lives under `adapters/persistence/`),
// the 6 identidad use cases, and provides `ACTOR_PORT`.
