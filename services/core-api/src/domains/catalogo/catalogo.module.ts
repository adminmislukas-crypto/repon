...
/**
 * design.md "Wiring de módulos y tokens". Phase 4b (this slice) adds the 2
 * unit-write use cases — `KyselyCatalogRepository.save()` was implemented
 * and tested in Phase 4a, so this is the first PR where the module wires a
 * complete, working write path end-to-end. `saveMany()` still throws ("not
 * yet available") until PR 6 — correct today because nothing in this
 * module's provider graph calls it yet.
